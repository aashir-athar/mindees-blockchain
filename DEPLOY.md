...
deferred hardening (RFC-6979 signatures, peer discovery, BLS aggregation, state pruning,
inactivity-leak recovery) is done. Run testnets with valueless coins until then.
